...
class VictorOmnidynamicLoader:
    ...
    def run(self, module_file, symbol_name, input_1, input_2, reload=False):
        try:
            ...
            if isinstance(target, type):
                ...
                if hasattr(instance, "forward"):
                    result = instance.forward([input_1, input_2])
                elif hasattr(instance, "main"):
                    result = instance.main(input_1, input_2)
                else:
